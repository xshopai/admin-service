# ============================================================================
# Azure Container Apps Deployment Script for Admin Service (PowerShell)
# ============================================================================
...
try {
    ...
    az containerapp create `
        ...
        --secrets "cosmos-conn=$CosmosConnectionString" `
        --env-vars `
            "PORT=$AppPort" `
            "NODE_ENV=production" `
...
Write-Host "Admin Service deployed! Dapr App ID: $AppName" -ForegroundColor Green
