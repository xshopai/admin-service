...
# Admin Service - Run with direct RabbitMQ (local development)

echo "Starting Admin Service (Direct RabbitMQ)..."
echo "Service will be available at: http://localhost:8003"
echo ""

# Kill any process using port 8003 (prevents "address already in use" errors)
PORT=8003
