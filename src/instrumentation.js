/**
 * Azure Monitor OpenTelemetry instrumentation for admin-service
 *
...
const serviceName = process.env.SERVICE_NAME || process.env.NAME || 'admin-service';
...
if (connectionString) {
  try {
    // Import Azure Monitor OpenTelemetry (ES module async import)
